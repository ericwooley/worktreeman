...
test("readDashboardUrlState infers page presentation from dedicated document path", () => {
  assert.deepEqual(
    readDashboardUrlState("/project-management/documents/doc-42", "?pmView=edit&pmEditTab=preview"),
    {
      selectedBranch: null,
      activeTab: "project-management",
      aiActivitySubTab: "log",
      ...
      systemSubTab: "performance",
      projectManagementSubTab: "document",
      projectManagementSelectedDocumentId: "doc-42",
